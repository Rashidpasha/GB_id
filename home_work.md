...
Позволяет переходить между разными камитами

## Инструкция работы с Markdown

## Выделение текста

Чтобы обрамить выделить текст курсивом, необходимо обрамить его звездочками
...
- Команды для работы с ветками
      ...
      git branch new_branch (задание новой ветки)
